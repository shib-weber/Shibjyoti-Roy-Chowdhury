    ...
    This app reflects my interest in personal productivity tools and data visualization.`,
        link: "https://github.com/shib-weber/Expense_Manager",
        live:"https://expense-manager-8wfq.onrender.com"
    },
    {
        project:"Project 4",
    ...
    },
    {
        ...
        description: `A multi-round Rock Paper Scissors game with scoring system and interactive visuals. 
    Includes game history, winner announcements, and animated transitions for each move. 
    Players can play multiple rounds with scorekeeping and match reset options. 
    Made using vanilla JavaScript and styled with custom CSS animations. 
    Can be easily integrated into educational or entertainment-based platforms. 
    Encourages strategic choices and adds suspense through randomized delays. 
    UI designed to mimic real-time play with quick feedback and engaging UX. 
    Perfect beginner-friendly game showcasing frontend logic and responsiveness.`,
        link: "https://github.com/shib-weber/Stone-Paper-Scissor-Game",
        live:"https://shib-weber.github.io/Stone-Paper-Scissor-Game/"
    },
    {
        project:"Project 8",
    ...
    {
        project:"Project 9",
        title: "Zelo – AI Chatbot with Cohere",
        description: `Zelo is an intelligent AI chatbot built using the Cohere NLP platform for smart replies. 
    It interacts in a human-like tone to assist users in various categories like productivity, study help, and motivation. 
    Built with React and integrated APIs to provide context-aware responses. 
    Capable of remembering short context and continuing conversation threads. 
    The UI is minimalistic yet futuristic with floating chat elements. 
    Suitable for embedding in personal sites or productivity platforms. 
